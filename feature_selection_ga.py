...
class FeatureSelectionGA:
    ...
    def _init_toolbox(self):
        ...
        toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.attr_bool, self.n_features) #membangkitkan populasi awal secara random generator
    ...
    def _default_toolbox(self):
        ...
        toolbox.register("select", tools.selTournament, tournsize=3) #seleksi menggunakan turnamen
        toolbox.register("evaluate", self.evaluate)
        return toolbox
    ...
    def generate(self,n_pop,cxpb = 0.5,mutxpb = 0.2,ngen=5,set_toolbox = False):
        ...
        for g in range(NGEN):
            ...
            # clone proses menghasilkan individu-individu dari jenis yang sama (populasi) yang identik secara genetik
            #seleksi individu
